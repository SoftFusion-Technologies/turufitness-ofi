  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-950 via-emerald-800 to-emerald-900 py-10 px-3 md:px-6 relative font-sans">
          ...
          {clientesFiltrados.length === 0 ? (
            ...
            clientesFiltrados.map((c) => (
              ...
              >
                ...
                {/* Info detallada */}
                <div className="flex-1 grid grid-cols-3 gap-6 px-8 py-6 bg-white/80 backdrop-blur-lg text-gray-800 items-center">
                  <div>
                  ...
                  <div>
                    ...
                    <div className="text-base">{c.fecha_alta || '-'}</div>
                  </div>
                  <div>
                    <div className="text-xs text-gray-500 font-semibold">
                      Fecha Vencimiento
      ...
      `}
            ...
            >
              {/* Header: Nombre + Badge pagado + Acciones */}
              ...
              {/* Datos clave agrupados (Mobile) */}
              <div className="grid grid-cols-2 gap-2 ">
                <div>
                  <div className="text-xs text-emerald-300 font-semibold">
                    DNI
                  </div>
                  <div className="text-sm text-white">{c.dni || '-'}</div>
                </div>
                <div>
                  <div className="text-xs text-emerald-300 font-semibold">
                    Teléfono
                  </div>
                  <div className="text-sm text-white">{c.telefono || '-'}</div>
                </div>
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-gray-800">
                ...
                <input
                  type="date"
                  placeholder="Última Notificación"
